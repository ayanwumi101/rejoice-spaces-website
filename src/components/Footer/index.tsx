...
const index = () => {
  return (
    <Box py='30px' borderTop='2px solid lightgray'>
        <Flex alignItems='center' justifyContent='space-between' w='80%' mx='auto'>
            <Box>
                <Text>Copywright © Rejoice Spaces, {new Date().getFullYear()}</Text>
            </Box>
            <Box>
                <Flex alignItems='center' gap='38px' color='white'>
